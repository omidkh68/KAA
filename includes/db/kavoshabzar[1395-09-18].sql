...
--
-- Host: localhost:3306
-- Generation Time: Dec 08, 2016 at 09:56 AM
...
(2, '<p>شرکت کاوش ابزار آریا با تجربه طولانی درزمینه نفت و گاز نیروگاه و صنایع دریایی در جهت جذب سازندگان موفق خارجی برای تامین نیازهای صنایع مختلف تلاش می نماید.\nهدف اصلی این شرکت تمرکز بر ارائه محصولات مهندسی قابل اطمینان ، هدایت مشتریان خود به سمت فناوری روز آمد مورد نیاز خود می باشد.\nما به نیاز و تعهد مشتریان ارزش می گذاریم . و با تمام توان در جهت تامین خواست های آنها قدم می گذاریم .\nهدف ما امینت ، سلامت ، ایمنی و محیط زیست مطابق با حفظ ارزشهای اجتماعی می باشد.</p>', 'fa');
...
INSERT INTO `copyright` (`Copyright_id`, `lang`, `text`) VALUES
(1, 'en', 'All rights reserved for Kavosh Abzar Aria Ltd.'),
(2, 'fa', 'تمام حق و حقوق این سایت متعلق به شرکت کاوش ابزار آریا می باشد.');
...
(1, 'admin', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'info@kavoshabzar.net');
...
--
ALTER TABLE `copyright`
  MODIFY `Copyright_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
