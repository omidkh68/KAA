...
<footer>
    <div class="lang-selector pull-left">
        <form id="changeLang" action="<?php echo DOMAIN_URL; ?>includes/changeLang.php" method="post">
            <input type="hidden" name="changeLang" id="changeLang">
            <ul>
                <li class="pull-left wow fadeIn" data-wow-duration="1s" data-wow-delay=".5s">
                    <a class="change_lang<?php echo (LANG == "en") ? ' active' : '' ?>" data-lang="en"
                ...
                <li class="pull-left wow fadeIn" data-wow-duration="1s" data-wow-delay=".6s">
                    <a class="change_lang<?php echo (LANG == "fa") ? ' active' : '' ?>" data-lang="fa"
