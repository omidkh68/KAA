                ...
                <div class="col-xs-12 colsm-12 col-md-12 itemContent">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a class="<?php echo (LANG == "fa") ? "rtl" : "ltr"; ?>" href="#OBSـTestـResults" aria-controls="OBS_Test_Results" role="tab" data-toggle="tab">
                                    <?php echo (LANG == "fa") ? "نتایج تست OBS" : "OBS Test Results"; ?>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <?php /*<div role="tabpanel" class="tab-pane fade" id="optimarinApprovals">
                                <?php
                                if(LANG == "fa") {
                                    ?>
                                <p class="rtl">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="OBSـTestـResults">
                                <p>
                                    The test results are well within the requirements.
                                </p>

                                <img class="center-block" src="<?php echo DOMAIN_URL; ?>assets/images/products/optimarin/TEST-RESULT-OBS.png" alt="OBS test results" style="max-width: 1000px;">
                            </div>
                        </div>
                    </div>
                </div>
