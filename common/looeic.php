 ...
 * Time: 4:33 AM
 */
include_once LOCAL_PATH.'common/GUMP-master/gump.class.php';
class looeic
{
    protected $fields;
    protected $rules;
    ...
    public function getByFilter($fields='')
    {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS
                 *
    		     FROM 	".$this->TABLE_NAME." ".$condition['list']['useWhere'].$condition['list']['WHERE'].$condition['list']['filter'].$condition['list']['order'].$condition['list']['limit'];
