...
function redirectPage($page, $message = '')
{
    ...
    <head>
        ...
        <script language="javascript">
            ...
            setTimeout("window.location='<?=$page ?>'", 0);
        </script>
        <style>
            body {
    ...
    <center>
        <div class="a">
            ...
            ?>
            <img src="<?php echo RELA_DIR . 'templates/' . CURRENT_SKIN . '/images/logo.png' ?> "
                 align="left" style="position:absolute; left:40px;padding-bottom:20px; " height="60">
